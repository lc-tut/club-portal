...
type ClubTimeRepo interface {
	...
	GetClubTimeByClubUUID(uuid string) (*models.ClubTime, error)
...
func (r *Repository) GetClubTimeByClubUUID(uuid string) (*models.ClubTime, error) {
	panic("implement me")
}
...
type ClubPlaceRepo interface {
	...
	GetClubPlaceByClubUUID(uuid string) (*models.ClubPlace, error)
...
func (r *Repository) GetClubPlaceByClubUUID(uuid string) (*models.ClubPlace, error) {
	panic("implement me")
}
